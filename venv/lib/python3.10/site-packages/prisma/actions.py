...
class InterviewScreenshotActions(Generic[_PrismaModelT]):
    __slots__ = (
        '_client',
        '_model',
    )
    ...
    async def query_raw(
        ...
        *args
        ...
        Returns
        -------
        List[prisma.models.InterviewScreenshot]
            The records returned by the SQL query
        ...
        -------
        ```py
        users = await InterviewScreenshot.prisma().query_raw(
            'SELECT * FROM InterviewScreenshot WHERE id = $1',
            'bajecchdjc',
        )
        ```
        """
    ...
    async def query_first(
        ...
        *args
        ...
        Returns
        -------
        prisma.models.InterviewScreenshot
            The first record returned by the SQL query
        None
            The raw SQL query did not return any records
        ...
        -------
        ```py
        user = await InterviewScreenshot.prisma().query_first(
            'SELECT * FROM InterviewScreenshot WHERE interviewId = $1',
            'dfgacajif',
        )
        ```
        """
    ...
    async def create(
        self,
        data: types.InterviewScreenshotCreateInput,
        include: Optional[types.InterviewScreenshotInclude] = None
    ) -> _PrismaModelT:
        """Create a new InterviewScreenshot record.

        Parameters
        ----------
        data
            InterviewScreenshot record data
        include
            Specifies which relations should be loaded on the returned InterviewScreenshot model

        Returns
        -------
        prisma.models.InterviewScreenshot
            The created InterviewScreenshot record
        ...
        -------
        ```py
        # create a InterviewScreenshot record from just the required fields
        interviewscreenshot = await InterviewScreenshot.prisma().create(
            data={
                # data to create a InterviewScreenshot record
    ...
    async def create_many(
        self,
        data: List[types.InterviewScreenshotCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> int:
        """Create multiple InterviewScreenshot records at once.
        ...
        ----------
        data
            List of InterviewScreenshot record data
        skip_duplicates
            Boolean flag for ignoring unique constraint errors
        ...
        -------
        ```py
        total = await InterviewScreenshot.prisma().create_many(
            data=[
                {
                    # data to create a InterviewScreenshot record
                    'interviewId': 'bahchhihdc',
                    'imageUrl': 'bihjdcibib',
                },
                {
                    # data to create a InterviewScreenshot record
                    'interviewId': 'bfhhjbbdha',
                    'imageUrl': 'faehcjfdb',
                },
            ],
            skip_duplicates=True,
    ...
    async def delete(
        self,
        where: types.InterviewScreenshotWhereUniqueInput,
        include: Optional[types.InterviewScreenshotInclude] = None
    ) -> Optional[_PrismaModelT]:
        """Delete a single InterviewScreenshot record.

        Parameters
        ----------
        where
            InterviewScreenshot filter to select the record to be deleted, must be unique
        include
            Specifies which relations should be loaded on the returned InterviewScreenshot model
        ...
        -------
        prisma.models.InterviewScreenshot
            The deleted InterviewScreenshot record
        None
            Could not find a record to delete
        ...
        -------
        ```py
        interviewscreenshot = await InterviewScreenshot.prisma().delete(
            where={
                'id': 'bbaiefbee',
            },
        )
    ...
    async def find_unique(
        ...
        """Find a unique InterviewScreenshot record.

        Parameters
        ----------
        where
            InterviewScreenshot filter to find the record, must be unique
        include
            Specifies which relations should be loaded on the returned InterviewScreenshot model
        ...
        -------
        prisma.models.InterviewScreenshot
            The found InterviewScreenshot record
        None
            No record matching the given input could be found
        ...
        -------
        ```py
        interviewscreenshot = await InterviewScreenshot.prisma().find_unique(
            where={
                'id': 'bdaacgjbaf',
            },
        )
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique InterviewScreenshot record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        interviewscreenshot = await InterviewScreenshot.prisma().find_unique_or_raise(
            where={
                'id': 'biibaighec',
            },
        )
    ...
    async def find_many(
        ...
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.InterviewScreenshotWhereInput] = None,
        cursor: Optional[types.InterviewScreenshotWhereUniqueInput] = None,
        include: Optional[types.InterviewScreenshotInclude] = None,
        order: Optional[Union[types.InterviewScreenshotOrderByInput, List[types.InterviewScreenshotOrderByInput]]] = None,
        distinct: Optional[List[types.InterviewScreenshotScalarFieldKeys]] = None,
    ) -> List[_PrismaModelT]:
        """Find multiple InterviewScreenshot records.
        ...
        ----------
        take
            Limit the maximum number of InterviewScreenshot records returned
        skip
            Ignore the first N results
        where
            InterviewScreenshot filter to select records
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned InterviewScreenshot model
        order
            Order the returned InterviewScreenshot records by any field
        distinct
            Filter InterviewScreenshot records by either a single distinct field or distinct combinations of fields

        Returns
        -------
        List[prisma.models.InterviewScreenshot]
            The list of all InterviewScreenshot records that could be found
        ...
        -------
        ```py
        # find the first 10 InterviewScreenshot records
        interviewscreenshots = await InterviewScreenshot.prisma().find_many(take=10)

        # find the first 5 InterviewScreenshot records ordered by the imageUrl field
        interviewscreenshots = await InterviewScreenshot.prisma().find_many(
            take=5,
            order={
                'imageUrl': 'desc',
            },
    ...
    async def find_first(
        ...
        """Find a single InterviewScreenshot record.
        ...
        skip
            Ignore the first N records
        where
            InterviewScreenshot filter to select the record
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned InterviewScreenshot model
        ...
        -------
        prisma.models.InterviewScreenshot
            The first InterviewScreenshot record found, matching the given arguments
        None
            No record could be found
        ...
        -------
        ```py
        # find the second InterviewScreenshot record ordered by the faceVerified field
        interviewscreenshot = await InterviewScreenshot.prisma().find_first(
            skip=1,
            order={
                'faceVerified': 'desc',
            },
    ...
    async def find_first_or_raise(
        ...
        """Find a single InterviewScreenshot record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second InterviewScreenshot record ordered by the multiFace field
        interviewscreenshot = await InterviewScreenshot.prisma().find_first_or_raise(
            skip=1,
            order={
                'multiFace': 'desc',
            },
    ...
    async def update(
        self,
        data: types.InterviewScreenshotUpdateInput,
        where: types.InterviewScreenshotWhereUniqueInput,
        include: Optional[types.InterviewScreenshotInclude] = None
    ) -> Optional[_PrismaModelT]:
        """Update a single InterviewScreenshot record.

        Parameters
        ----------
        data
            InterviewScreenshot record data specifying what to update
        where
            InterviewScreenshot filter to select the unique record to create / update
        include
            Specifies which relations should be loaded on the returned InterviewScreenshot model
        ...
        -------
        prisma.models.InterviewScreenshot
            The updated InterviewScreenshot record
        None
            No record could be found
        ...
        -------
        ```py
        interviewscreenshot = await InterviewScreenshot.prisma().update(
            where={
                'id': 'baicdfeidj',
            },
            data={
                # data to update the InterviewScreenshot record to
            },
        )
        ```
        """
    ...
    async def upsert(
        self,
        where: types.InterviewScreenshotWhereUniqueInput,
        data: types.InterviewScreenshotUpsertInput,
        include: Optional[types.InterviewScreenshotInclude] = None,
    ) -> _PrismaModelT:
        """Updates an existing record or create a new one
        ...
        -------
        prisma.models.InterviewScreenshot
            The created or updated InterviewScreenshot record
        ...
        -------
        ```py
        interviewscreenshot = await InterviewScreenshot.prisma().upsert(
            where={
                'id': 'befgiciadg',
            },
            data={
    ...
    async def update_many(
        self,
        data: types.InterviewScreenshotUpdateManyMutationInput,
        where: types.InterviewScreenshotWhereInput,
    ) -> int:
        """Update multiple InterviewScreenshot records

        Parameters
        ----------
        data
            InterviewScreenshot data to update the selected InterviewScreenshot records to
        where
            Filter to select the InterviewScreenshot records to update

        Returns
        -------
        int
            The total number of InterviewScreenshot records that were updated
        ...
        -------
        ```py
        # update all InterviewScreenshot records
        total = await InterviewScreenshot.prisma().update_many(
            data={
                'note': 'cbcehahedh'
            },
            where={}
    ...
    async def count(
        ...
        """Count the number of InterviewScreenshot records present in the database

        Parameters
        ----------
        select
            Select the InterviewScreenshot fields to be counted
        take
            Limit the maximum result
        skip
            Ignore the first N records
        where
            InterviewScreenshot filter to find records
        cursor
            Specifies the position in the list to start counting results from, (typically an ID field)
        order
            This parameter is deprecated and will be removed in a future release
        ...
        prisma.types.InterviewScreenshotCountAggregateOutput
            Data returned when `select` is used, the fields present in this dictionary will
            match the fields passed in the `select` argument
        ...
        ```py
        # total: int
        total = await InterviewScreenshot.prisma().count()

        # results: prisma.types.InterviewScreenshotCountAggregateOutput
        results = await InterviewScreenshot.prisma().count(
            select={
                '_all': True,
                'capturedAt': True,
            },
    ...
    async def count(
        self,
        select: types.InterviewScreenshotCountAggregateInput,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.InterviewScreenshotWhereInput] = None,
        cursor: Optional[types.InterviewScreenshotWhereUniqueInput] = None,
    ) -> types.InterviewScreenshotCountAggregateOutput:
        ...

    async def count(
        self,
        select: Optional[types.InterviewScreenshotCountAggregateInput] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.InterviewScreenshotWhereInput] = None,
        cursor: Optional[types.InterviewScreenshotWhereUniqueInput] = None,
    ) -> Union[int, types.InterviewScreenshotCountAggregateOutput]:
        """Count the number of InterviewScreenshot records present in the database
        ...
        if select is None:
            ...
            return cast(types.InterviewScreenshotCountAggregateOutput, resp['data']['result']['_count'])

    async def delete_many(
        self,
        where: Optional[types.InterviewScreenshotWhereInput] = None
    ) -> int:
        """Delete multiple InterviewScreenshot records.

        Parameters
        ----------
        where
            Optional InterviewScreenshot filter to find the records to be deleted

        Returns
        -------
        int
            The total number of InterviewScreenshot records that were deleted
        ...
        -------
        ```py
        # delete all InterviewScreenshot records
        total = await InterviewScreenshot.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            method='delete_many',
    ...
    async def group_by(
        self,
        by: List['types.InterviewScreenshotScalarFieldKeys'],
        *,
        where: Optional['types.InterviewScreenshotWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        avg: Optional['types.InterviewScreenshotAvgAggregateInput'] = None,
        sum: Optional['types.InterviewScreenshotSumAggregateInput'] = None,
        min: Optional['types.InterviewScreenshotMinAggregateInput'] = None,
        max: Optional['types.InterviewScreenshotMaxAggregateInput'] = None,
        having: Optional['types.InterviewScreenshotScalarWhereWithAggregatesInput'] = None,
        count: Optional[Union[bool, 'types.InterviewScreenshotCountAggregateInput']] = None,
        order: Optional[Union[Mapping['types.InterviewScreenshotScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.InterviewScreenshotScalarFieldKeys', 'types.SortOrder']]]] = None,
    ) -> List['types.InterviewScreenshotGroupByOutput']:
        """Group InterviewScreenshot records by one or more field values and perform aggregations
        each group such as finding the average.

        Parameters
        ----------
        by
            List of scalar InterviewScreenshot fields to group records by
        where
            InterviewScreenshot filter to select records
        take
            Limit the maximum number of InterviewScreenshot records returned
        ...
        Returns
        -------
        List[prisma.types.InterviewScreenshotGroupByOutput]
            A list of dictionaries representing the InterviewScreenshot record,
            this will also have additional fields present if aggregation arguments
            are used (see the above parameters)
        ...
        -------
        ```py
        # group InterviewScreenshot records by interviewId values
        # and count how many records are in each group
        results = await InterviewScreenshot.prisma().group_by(
            ['interviewId'],
            count=True,
        )
        ```
...
class InterviewResultActions(Generic[_PrismaModelT]):
    ...
    async def create(
        ...
        interviewresult = await InterviewResult.prisma().create(
            data={
                ...
                'interviewId': 'bcggehiidc',
                'candidateId': 'bjcdacgacf',
                'jobId': 'jfieeahi',
                'evaluatedCount': 1895913359,
                'totalQuestions': 232393244,
                'averageFactualAccuracy': 1116931621.124302,
                'averageCompleteness': 21355947.83123,
                'averageRelevance': 1024647073.41434,
                'averageCoherence': 1090693511.166431,
                'averageScore': 761058525.149842,
                'passStatus': 'bjgacaeagh',
                'summaryResult': 'beeaihbefg',
                'knowledgeLevel': 'bfbfgeddfd',
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await InterviewResult.prisma().create_many(
            data=[
                {
                    # data to create a InterviewResult record
                    'interviewId': 'jbgheibja',
                    'candidateId': 'eejajbid',
                    'jobId': 'efhdcdaie',
                    'evaluatedCount': 2034942613,
                    'totalQuestions': 1079799722,
                    'averageFactualAccuracy': 417171355.138452,
                    'averageCompleteness': 274854673.56897,
                    'averageRelevance': 721617527.151116,
                    'averageCoherence': 81899341.204782,
                    'averageScore': 1620791059.187764,
                    'passStatus': 'bdgbfahbef',
                    'summaryResult': 'fccjhidic',
                    'knowledgeLevel': 'bdgfdgdaff',
                },
                {
                    # data to create a InterviewResult record
                    'interviewId': 'bicgeaiaga',
                    'candidateId': 'fajhhafab',
                    'jobId': 'bfeiccieec',
                    'evaluatedCount': 728468875,
                    'totalQuestions': 107859560,
                    'averageFactualAccuracy': 1041547905.192730,
                    'averageCompleteness': 520320871.113281,
                    'averageRelevance': 1061815741.183620,
                    'averageCoherence': 742793987.26594,
                    'averageScore': 462831801.24799,
                    'passStatus': 'hiaaaeeeh',
                    'summaryResult': 'ediajdeie',
                    'knowledgeLevel': 'jdgefgafd',
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second InterviewResult record ordered by the evaluatedCount field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group InterviewResult records by averageRelevance values
        # and count how many records are in each group
        ...
        *,
        ...
        total = await ChatHistory.prisma().create_many(
            data=[
                {
                    # data to create a ChatHistory record
                    'interviewId': 'bbbjadabjc',
                    'question': 'hhaechedd',
                },
                {
                    # data to create a ChatHistory record
                    'interviewId': 'gjjgegdic',
                    'question': 'bijbiccd',
                },
            ],
            skip_duplicates=True,
...
class EvaluationActions(Generic[_PrismaModelT]):
        ...
        *,
        ...
        total = await Evaluation.prisma().create_many(
            data=[
                {
                    # data to create a Evaluation record
                    'interviewId': 'edcgchech',
                    'question': 'bfehccdcge',
                    'answer': 'ehcibdegf',
                },
                {
                    # data to create a Evaluation record
                    'interviewId': 'ebhjifbbi',
                    'question': 'jaigficdj',
                    'answer': 'bggcfifgbc',
                },
            ],
    ...
    async def update_many(
        ...
        total = await Evaluation.prisma().update_many(
            data={
                'factualAccuracyExplanation': 'bhgjecjac'
            },
            where={}
        )
        ```
