...
class Candidate(bases.BaseCandidate):
    ...
    applicationStatus: Optional[_str] = None
    interviewStatus: Optional[_str] = None
...
class Evaluation(bases.BaseEvaluation):
    ...
    def create_partial(
        ...
        try:
            ...
            if relations:
                raise ValueError('Model: "Evaluation" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
...
_Evaluation_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
