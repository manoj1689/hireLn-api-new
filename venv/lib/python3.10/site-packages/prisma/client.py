...
SCHEMA_PATH = Path('/home/monty/Documents/hireFast/lts/current/hireLn-api/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/monty/.cache/prisma-python/binaries/5.4.2/ac9d7041ed77bcc8a8dbd2ab6616b39013829574/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    companylocation: 'actions.CompanyLocationActions[models.CompanyLocation]'
    teammember: 'actions.TeamMemberActions[models.TeamMember]'
    ...
    billingaddress: 'actions.BillingAddressActions[models.BillingAddress]'
    invoice: 'actions.InvoiceActions[models.Invoice]'
    subscriptionaddon: 'actions.SubscriptionAddonActions[models.SubscriptionAddon]'
    jobsession: 'actions.JobSessionActions[models.JobSession]'
    skillsuggestion: 'actions.SkillSuggestionActions[models.SkillSuggestion]'
    ...
    interviewscreenshot: 'actions.InterviewScreenshotActions[models.InterviewScreenshot]'
    interviewresult: 'actions.InterviewResultActions[models.InterviewResult]'
    chathistory: 'actions.ChatHistoryActions[models.ChatHistory]'
    evaluation: 'actions.EvaluationActions[models.Evaluation]'
    ...
    def __init__(
        ...
        *,
        ...
        self.companylocation = actions.CompanyLocationActions[models.CompanyLocation](self, models.CompanyLocation)
        self.teammember = actions.TeamMemberActions[models.TeamMember](self, models.TeamMember)
        ...
        self.billingaddress = actions.BillingAddressActions[models.BillingAddress](self, models.BillingAddress)
        self.invoice = actions.InvoiceActions[models.Invoice](self, models.Invoice)
        self.subscriptionaddon = actions.SubscriptionAddonActions[models.SubscriptionAddon](self, models.SubscriptionAddon)
        self.jobsession = actions.JobSessionActions[models.JobSession](self, models.JobSession)
        self.skillsuggestion = actions.SkillSuggestionActions[models.SkillSuggestion](self, models.SkillSuggestion)
        ...
        self.interviewscreenshot = actions.InterviewScreenshotActions[models.InterviewScreenshot](self, models.InterviewScreenshot)
        self.interviewresult = actions.InterviewResultActions[models.InterviewResult](self, models.InterviewResult)
        self.chathistory = actions.ChatHistoryActions[models.ChatHistory](self, models.ChatHistory)
        self.evaluation = actions.EvaluationActions[models.Evaluation](self, models.Evaluation)
...
class Batch:
    ...
    companylocation: 'CompanyLocationBatchActions'
    teammember: 'TeamMemberBatchActions'
    subscription: 'SubscriptionBatchActions'
    paymentmethod: 'PaymentMethodBatchActions'
    billingaddress: 'BillingAddressBatchActions'
    invoice: 'InvoiceBatchActions'
    subscriptionaddon: 'SubscriptionAddonBatchActions'
    jobsession: 'JobSessionBatchActions'
    skillsuggestion: 'SkillSuggestionBatchActions'
    job: 'JobBatchActions'
    candidate: 'CandidateBatchActions'
    application: 'ApplicationBatchActions'
    interview: 'InterviewBatchActions'
    interviewscreenshot: 'InterviewScreenshotBatchActions'
    interviewresult: 'InterviewResultBatchActions'
    chathistory: 'ChatHistoryBatchActions'
    evaluation: 'EvaluationBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.companylocation = CompanyLocationBatchActions(self)
        self.teammember = TeamMemberBatchActions(self)
        self.subscription = SubscriptionBatchActions(self)
        self.paymentmethod = PaymentMethodBatchActions(self)
        self.billingaddress = BillingAddressBatchActions(self)
        self.invoice = InvoiceBatchActions(self)
        self.subscriptionaddon = SubscriptionAddonBatchActions(self)
        self.jobsession = JobSessionBatchActions(self)
        self.skillsuggestion = SkillSuggestionBatchActions(self)
        ...
        self.interviewscreenshot = InterviewScreenshotBatchActions(self)
        self.interviewresult = InterviewResultBatchActions(self)
        self.chathistory = ChatHistoryBatchActions(self)
        self.evaluation = EvaluationBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class CompanyLocationBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class BillingAddressBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class SubscriptionAddonBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class SkillSuggestionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class InterviewScreenshotBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.InterviewScreenshot,
            arguments={
                'data': data,
                'include': include,
            },
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class InterviewResultBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
