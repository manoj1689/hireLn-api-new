...
class SkillSuggestion(bases.BaseSkillSuggestion):
    """Represents a SkillSuggestion record"""

    id: _str
    department: _str
    suggestions: List[_str]
    createdAt: datetime.datetime
    updatedAt: datetime.datetime
    candidates: Optional[List['models.Candidate']] = None
    jobs: Optional[List['models.Job']] = None
    ...
    @field_validator('suggestions', pre=True, allow_reuse=True)
    @classmethod
    def _transform_required_list_fields(cls, value: object) -> object:
        # When using raw queries, some databases will return `None` for an array field that has not been set yet.
        #
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.SkillSuggestionKeys']] = None,
        exclude: Optional[Iterable['types.SkillSuggestionKeys']] = None,
        required: Optional[Iterable['types.SkillSuggestionKeys']] = None,
        optional: Optional[Iterable['types.SkillSuggestionKeys']] = None,
        relations: Optional[Mapping['types.SkillSuggestionRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.SkillSuggestionKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _SkillSuggestion_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _SkillSuggestion_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _SkillSuggestion_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _SkillSuggestion_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _SkillSuggestion_relational_fields:
                        raise errors.UnknownRelationalFieldError('SkillSuggestion', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid SkillSuggestion / {name} field.'
            ) from None
...
class Job(bases.BaseJob):
    ...
    userId: _str
    user: Optional['models.User'] = None
    skillSuggestions: Optional[List['models.SkillSuggestion']] = None
    applications: Optional[List['models.Application']] = None
    interviews: Optional[List['models.Interview']] = None
...
class Interview(bases.BaseInterview):
    ...
    screenshots: Optional[List['models.InterviewScreenshot']] = None
...
class InterviewScreenshot(bases.BaseInterviewScreenshot):
    """Represents a InterviewScreenshot record"""

    id: _str
    interviewId: _str
    imageUrl: _str
    faceVerified: Optional[_bool] = None
    multiFace: Optional[_bool] = None
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.InterviewScreenshotKeys']] = None,
        exclude: Optional[Iterable['types.InterviewScreenshotKeys']] = None,
        required: Optional[Iterable['types.InterviewScreenshotKeys']] = None,
        optional: Optional[Iterable['types.InterviewScreenshotKeys']] = None,
        relations: Optional[Mapping['types.InterviewScreenshotRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.InterviewScreenshotKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _InterviewScreenshot_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _InterviewScreenshot_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _InterviewScreenshot_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _InterviewScreenshot_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _InterviewScreenshot_relational_fields:
                        raise errors.UnknownRelationalFieldError('InterviewScreenshot', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid InterviewScreenshot / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'InterviewScreenshot',
            }
        )
        _created_partial_types.add(name)
...
_SkillSuggestion_relational_fields: Set[str] = {
        'candidates',
        'jobs',
    }
_SkillSuggestion_fields: Dict['types.SkillSuggestionKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
_Job_fields: Dict['types.JobKeys', PartialModelField] = OrderedDict(
    [
        ...
        ('skillSuggestions', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.SkillSuggestion\']',
            'is_relational': True,
            'documentation': None,
        }),
        ('applications', {
...
_Interview_fields: Dict['types.InterviewKeys', PartialModelField] = OrderedDict(
    [
        ...
        ('screenshots', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.InterviewScreenshot\']',
            'is_relational': True,
            'documentation': None,
        }),
    ],
...
_InterviewScreenshot_relational_fields: Set[str] = {
        'interview',
    }
_InterviewScreenshot_fields: Dict['types.InterviewScreenshotKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
